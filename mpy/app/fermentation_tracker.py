    ...
    def __init__(self,
        ...
        while True:
            ...
            try:
                ...
                print("Sensors initialized. Initing Asana")
                ...
                print("Google initialized. Writing sheet URL to Asana task desc")
